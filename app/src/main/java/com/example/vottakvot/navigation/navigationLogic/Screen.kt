...
sealed class  Screen(
    ...
    object MyExercise : Screen(route = ROUTE_MY_EXERCISE_SCREEN)
    ...
    //----------WORKOUT------PREPARAION---DOING---REST------------
    object Preparation : Screen(route = ROUTE_PREPARATION_SCREEN)
    object Doing: Screen(route = ROUTE_DOING_SCREEN)
    object Rest : Screen(route = ROUTE_REST_SCREEN)
    //----------WORKOUT------TYPE---------------------------------
    ...
    object ExerciseList : Screen(route = ROUTE_EXERCISE_LIST_SCREEN)
    ...
    private companion object {
        ...
        const val ROUTE_MY_EXERCISE_SCREEN = "my_exercise_screen"
        ...
        //-------------------------------
        const val ROUTE_PREPARATION_SCREEN = "preparation_screen"
        const val ROUTE_DOING_SCREEN = "doing_screen"
        const val ROUTE_REST_SCREEN = "rest_screen"
        //-------------------------------
        ...
        const val ROUTE_EXERCISE_LIST_SCREEN = "rout_exercises_list_screen"
